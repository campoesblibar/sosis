Ext.define('SCH.module.GeneralSetup.Role.controller.Role', {
    extend  : 'Ext.app.Controller',
    CheckedDataEdit: [],

    init: function() {
        var me = this;
        me.getStore('SCH.module.GeneralSetup.Role.store.Role').load();
        me.getStore('SCH.module.GeneralSetup.Role.store.RoleMenu').load();
        me.control({
    ...
    reloadStore: function(){
        var me = this;
        me.getStore('SCH.module.GeneralSetup.Role.store.Role').reload();
    },
    ...
    viewRole: function(grid, record, item, index, e, eOpts){
        ...
        Ext.Ajax.request({
            ...
            success         : function(response){
                ...
                var storeMenu = Ext.getStore('SCH.module.GeneralSetup.Role.store.RoleMenu');
                    ...
                    Ext.Ajax.request({
                        ...
                        success         : function(response){
                            ...
                            if(data.msg === 1){
                                ...
                                var storeApproval = Ext.getStore('SCH.module.GeneralSetup.Role.store.Role');
    ...
    reset: function(btn) {//Reset Form
        ...
        me.getStore('SCH.module.GeneralSetup.Role.store.Role').reload();
        me.getStore('SCH.module.GeneralSetup.Role.store.RoleMenu').reload();
        ...
        Ext.Ajax.request({
            ...
            success : function(response){
                ...
                if(data.total === 1){
                    ...
                    me.reset();
                    me.getStore('SCH.module.GeneralSetup.Role.store.Role').removeAll();
                    me.getStore('SCH.module.GeneralSetup.Role.store.Role').reload();
    ...
    addRole: function(grid, record, item, index, e, eOpts){
        ...
        if(record.data.id_role === '' || record.data.id_role === null)
        {
            ...
            this.getStore('SCH.module.GeneralSetup.Role.store.ViewAllMenu').reload(); 
            this.getStore('SCH.module.GeneralSetup.Role.store.ViewAllMenu').removeAll();      
            var win = Ext.create('SCH.module.GeneralSetup.Role.view.form.FormRoleMenu');
            win.show();
        ...
        Ext.Ajax.request({
            ...
            success : function(response){
                ...
                if(data.total === 0){
                    ...
                    win.close();
                    var storeMenu = Ext.getStore('SCH.module.GeneralSetup.store.RoleMenu');
                    storeMenu.removeAll();
                    toreMenu.reload();
                    storeMenu.add(data.data);
