Ext.define('SCH.module.GeneralSetup.Role.view.grid.GridRoleMenu', {
    extend   : 'Ext.grid.Panel',
    store    : 'SCH.module.GeneralSetup.Role.store.RoleMenu',
                            ...
                            if (btn == 'yes') {
                                Ext.Ajax.request({
                                    ...
                                    success         : function(response){
                                        ...
                                        var storeModul = Ext.getStore('SCH.module.GeneralSetup.Role.store.RoleMenu');
