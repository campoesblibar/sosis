Ext.define('SCH.module.GeneralSetup.Role.view.form.FormRoleMenu', {
    extend      : 'Ext.window.Window',
    closeable   : true,
    modal       : true,
    requires    : ['SCH.module.GeneralSetup.Role.store.ViewAllMenu'],
        ...
        me.items  = [
            {
                ...
                items       : [
                    ...
                    },
                    {
                        ...
                        fieldLabel  : 'Menu',
                        autoScroll  : false,
                        store       : Ext.create('SCH.module.GeneralSetup.Role.store.ViewAllMenu'),
